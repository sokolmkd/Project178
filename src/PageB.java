 ...
 * @author Victor
 */
public class PageB extends javax.swing.JFrame {
   ...
   public static BufferedImage scaleImage(int w, int h, BufferedImage img) throws Exception {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
